...
Exit"
    ...
    case $chosen in
        ...
        Exit)
            exit;;
        "$selfile")
            ~/.config/eww/panel/bin/screenshot.sh selection file;;
        "$selclip")
            ~/.config/eww/panel/bin/screenshot.sh selection clip;;
        "$screenfile")
            ~/.config/eww/panel/bin/screenshot.sh monitor file;;
        "$screenclip")
            ~/.config/eww/panel/bin/screenshot.sh monitor clip;;
    esac
    main_menu
